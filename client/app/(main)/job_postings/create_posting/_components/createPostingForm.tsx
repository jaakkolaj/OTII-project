...
import {
  ...
  type CreatePostingFormState,
} from "../actions";

const initialState: CreatePostingFormState = null;

export default function CreatePostingForm() {
  
  const [state, formAction] = useActionState(createJobPostingAction, initialState);
  ...
  return (
    <form action={formAction} className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-end gap-3">
        ...
        <FormSubmitButton text="Create posting" loadingText="Creating" size="lg"/>
      </div>
    </form>
  );
}
